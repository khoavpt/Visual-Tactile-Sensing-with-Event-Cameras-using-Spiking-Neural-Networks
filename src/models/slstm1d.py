...
from ..layers.basic_spiking_block_old import ConvSpikingBlockOld, LinearSpikingBlockOld

class SpikingConvLSTM1d(BaseSpikingModel):
    def __init__(self, beta_init, feature_size=64, spikegrad="fast_sigmoid", in_channels=1, lr=0.001):
        ...
        # Conv block 1
        self.conv_block1 = ConvSpikingBlockOld(
        ...
        # Conv block 2
        self.conv_block2 = ConvSpikingBlockOld(
        ...
        # Linear block 1
        self.linear_block1 = LinearSpikingBlockOld(
        ...
        # Linear block 2
        self.linear_block2 = LinearSpikingBlockOld(
